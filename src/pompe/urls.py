...
urlpatterns = [
    ...
    #path('dashboard/lieux', views.equipe, name="lieux"),
    #path('dashboard/fabriquant', views.equipe, name="fabriquant"),
    path('stock_add/', views.add_stockpompe, name="add_pompe"),
    path('stock_edit/<int:pk>/', views.update_stockpompe, name="pompe_edit"),
    path('fichepompe_add/', views.add_fichepompe, name="add_fiche_pompe"),
    path('fichepompe_edit/<int:pk>/', views.update_fichepompe, name="fichepompe_edit"),
    path('pompes/inventaire/', view.inventaire, name="inventaire"),
    ...
    path('equipe_add/', views.add_equipe, name="add_equipe"),
    #path('equipe_edit/<int:pk>/', views.update_equipe, name="equipe_edit"),
