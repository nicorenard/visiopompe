...
urlpatterns = [
    ...
    path('site_delete/<int:pk>/', views.delete_site, name="site_delete"),
    path('batiment_edit/<int:pk>/', views.update_batiment, name="batiment_edit"),
    path('batiment_delete/<int:pk>/', views.delete_batiment, name="batiment_delete"),
    path('etage_edit/<int:pk>/', views.update_etage, name="etage_edit"),
    path('etage_delete/<int:pk>/', views.delete_etage, name="etage_delete"),
